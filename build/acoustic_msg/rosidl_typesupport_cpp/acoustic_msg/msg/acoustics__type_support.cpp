...
static const _Acoustics_type_support_symbol_names_t _Acoustics_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, acoustic_msg, msg, Acoustics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, acoustic_msg, msg, Acoustics)),
  }
};
...
{
  return &::acoustic_msg::msg::rosidl_typesupport_cpp::Acoustics_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, acoustic_msg, msg, Acoustics)() {
  return get_message_type_support_handle<acoustic_msg::msg::Acoustics>();
}
