...
static const _AccelerationZ_type_support_symbol_names_t _AccelerationZ_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, linear_acceleration_msg, msg, AccelerationZ)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, linear_acceleration_msg, msg, AccelerationZ)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, linear_acceleration_msg, msg, AccelerationZ)() {
  return &::linear_acceleration_msg::msg::rosidl_typesupport_c::AccelerationZ_message_type_support_handle;
}
