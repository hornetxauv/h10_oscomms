...
static const _AccelerationXY_type_support_symbol_names_t _AccelerationXY_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, linear_acceleration_msg, msg, AccelerationXY)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, linear_acceleration_msg, msg, AccelerationXY)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, linear_acceleration_msg, msg, AccelerationXY)() {
  return &::linear_acceleration_msg::msg::rosidl_typesupport_c::AccelerationXY_message_type_support_handle;
}
