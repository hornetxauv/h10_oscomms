...
static const _Acceleration_type_support_symbol_names_t _Acceleration_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, linear_acceleration_msg, msg, Acceleration)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, linear_acceleration_msg, msg, Acceleration)),
  }
};
...
{
  return &::linear_acceleration_msg::msg::rosidl_typesupport_cpp::Acceleration_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, linear_acceleration_msg, msg, Acceleration)() {
  return get_message_type_support_handle<linear_acceleration_msg::msg::Acceleration>();
}
