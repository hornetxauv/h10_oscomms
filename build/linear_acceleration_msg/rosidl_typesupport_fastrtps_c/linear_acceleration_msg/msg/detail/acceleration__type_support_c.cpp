...
#include "linear_acceleration_msg/msg/detail/acceleration__rosidl_typesupport_fastrtps_c.h"
...
using _Acceleration__ros_msg_type = linear_acceleration_msg__msg__Acceleration;
...
size_t get_serialized_size_linear_acceleration_msg__msg__Acceleration(
  const void * untyped_ros_message,
...
static uint32_t _Acceleration__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_linear_acceleration_msg__msg__Acceleration(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_linear_acceleration_msg
size_t max_serialized_size_linear_acceleration_msg__msg__Acceleration(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = linear_acceleration_msg__msg__Acceleration;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _Acceleration__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_linear_acceleration_msg__msg__Acceleration(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, linear_acceleration_msg, msg, Acceleration)() {
