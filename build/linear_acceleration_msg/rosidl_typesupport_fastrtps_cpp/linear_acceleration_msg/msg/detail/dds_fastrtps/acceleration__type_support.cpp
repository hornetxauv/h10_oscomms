...
#include "linear_acceleration_msg/msg/detail/acceleration__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = linear_acceleration_msg::msg::Acceleration;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const linear_acceleration_msg::msg::Acceleration *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<linear_acceleration_msg::msg::Acceleration *>(
    untyped_ros_message);
...
static size_t _Acceleration__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Acceleration(full_bounded, is_plain, 0);
...
{
  return &linear_acceleration_msg::msg::typesupport_fastrtps_cpp::_Acceleration__handle;
}
